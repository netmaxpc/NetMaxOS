...
// ---------- Voice Controls Hook ----------
function useVoiceControls(onOpenApp, onCloseTop, onToggleStart) {
...
export default function NetMaxOS() {
  ...
  function newWin(app: AppId): Win { /* unchanged */ }
  function openApp(app: AppId) { /* unchanged */ }
  function closeTop() { /* unchanged */ }
  function closeWin(id: string) { /* unchanged */ }
  function focusWin(id: string) { /* unchanged */ }

  useEffect(() => { /* dragging logic unchanged */ }, [wins]);
  ...
  if (showSplash) {
    return (
      <div className="w-full h-full flex items-center justify-center bg-black" style={{background: theme.bg}}>
        <img src="/netmax-logo.png" alt="NetMax Logo" className="h-32 w-auto animate-pulse" />
      </div>
    );
  }
  ...
  return (
    <div className="relative w-full h-full" style={desktopWallpaper}>
      ...
      {splashOpen && (
        ...
        >
          <img src="/netmax-logo.png" alt="NetMaxOS" className="h-28 w-28 object-contain drop-shadow" />
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('/netmax-logo.png'), linear-gradient(transparent, transparent)",
      ...
      <div ref={desktopRef} className="relative w-full h-full">
        {/* Open windows */}
        {/* ... unchanged windows rendering */}

        {/* Start Menu */}
        {/* ... unchanged */}

        {/* Taskbar */}
        {/* ... unchanged, logo button present */}
